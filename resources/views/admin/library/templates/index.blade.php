    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Шаблоны</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Шаблоны</h3>
                    ...
                    <a href="{{ route('templates.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($templates as $template)
                            <tr>
                                <th class="text-center" scope="row">{{ $template->id }}</th>
                                <td>{{ $template->name }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('templates.store', $template->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('templates.destroy', $template->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
                    ...
                    {{ $templates->links('admin.layouts.admin_pagination') }}
