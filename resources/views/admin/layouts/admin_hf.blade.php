    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    <li>
                        <a href="/adfox"><i class="si si-cup"></i><span class="sidebar-mini-hide">Adfox</span></a>
                    </li>
                    <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span class="sidebar-mini-hidden">МЕНЮ</span></li>
                    <li>
                        <a href="/sites"><i class="si si-cup"></i><span class="sidebar-mini-hide">Сайты</span></a>
                    </li>
                    <li>
                        <a href="/places"><i class="si si-cup"></i><span class="sidebar-mini-hide">Рекламные места</span></a>
                    </li>
                    <li>
                        <a href="/adverts"><i class="si si-cup"></i><span class="sidebar-mini-hide">Рекламодатели</span></a>
                    </li>
                    <li>
                        <a href="/targets"><i class="si si-cup"></i><span class="sidebar-mini-hide">Цели</span></a>
                    </li>
                    <li>
                        <a href="/teasers"><i class="si si-cup"></i><span class="sidebar-mini-hide">Тизеры</span></a>
                    </li>
                    <li>
                        <a href="/ads"><i class="si si-cup"></i><span class="sidebar-mini-hide">Реклама</span></a>
                    </li>
                    <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span class="sidebar-mini-hidden">Библиотека</span></li>
                    <li>
                        <a href="/library/templates"><i class="si si-cup"></i><span class="sidebar-mini-hide">Шаблоны</span></a>
                    </li>
                    <li>
                        <a href="/library/images"><i class="si si-cup"></i><span class="sidebar-mini-hide">Изображения</span></a>
                    </li>
                    <br>
                    <br>
                    <br>
                    <br>
                    <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span class="sidebar-mini-hidden">PAGES</span></li>
                    <li class="open">
    ...
    <footer id="page-footer" class="opacity-0">
        <div class="content py-20 font-size-sm clearfix">
            <div class="float-right">
                Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="/" target="_blank">VitalyWeb</a>
            </div>
            <div class="float-left">
                <a class="font-w600" href="/" target="_blank">Codebase 3.4</a> &copy; <span class="js-year-copy"></span>
            </div>
        </div>
    </footer>
    <!-- END Footer -->
