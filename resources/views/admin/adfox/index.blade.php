    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Adfoxes</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Adfoxes</h3>
                    ...
                    <a href="{{ route('adfox.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($adfoxes as $adfox)
                            <tr>
                                <th class="text-center" scope="row">{{ $adfox->id }}</th>
                                <td>{{ $adfox->name }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('adfox.store', $adfox->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('adfox.destroy', $adfox->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
                    ...
                    {{ $adfoxes->links('admin.layouts.admin_pagination') }}
