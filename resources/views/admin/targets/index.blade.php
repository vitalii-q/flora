    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Цели</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <a href="{{ route('targets.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($targets as $target)
                            <tr>
                                <th class="text-center" scope="row">{{ $target->id }}</th>
                                <td>{{ $target->name }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('targets.store', $target->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('targets.destroy', $target->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
                    ...
                    {{ $targets->links('admin.layouts.admin_pagination') }}
