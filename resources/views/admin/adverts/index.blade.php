    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Рекламодатели</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <a href="{{ route('adverts.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($adverts as $advert)
                            <tr>
                                <th class="text-center" scope="row">{{ $advert->id }}</th>
                                <td>{{ $advert->name }}</td>
                                ...
                                <td class=""> <!-- text-center -->
                                    <div class="btn-group btn-group_table-custom">
                                        ...
                                        <a href="{{ route('adverts.edit', $advert->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('adverts.destroy', $advert->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
                    ...
                    {{ $adverts->links('admin.layouts.admin_pagination') }}
