    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Тизеры</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Тизеры</h3>
                    ...
                    <a href="{{ route('teasers.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($teasers as $teaser)
                            <tr>
                                <th class="text-center" scope="row">{{ $teaser->id }}</th>
                                <td>{{ $teaser->name }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('teasers.store', $teaser->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('teasers.destroy', $teaser->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
...
{{--                    {{ $tags->links('admin.layouts.admin_pagination') }}--}}
