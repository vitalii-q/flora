    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Сайты</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <a href="{{ route('sites.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($sites as $site)
                            <tr>
                                <th class="text-center" scope="row">{{ $site->id }}</th>
                                <td>{{ $site->name }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('sites.edit', $site->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('sites.destroy', $site->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
